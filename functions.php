...
add_action('wp_enqueue_scripts', 'davisdefense_scripts', 100);
function davisdefense_scripts(){
  wp_register_script(
    'bootstrap-script', 
  ...
  wp_register_script(
    'google-maps',
    '//maps.googleapis.com/maps/api/js?key=AIzaSyDE4qr4rE24Aq6J45Zp6CZ2AIMqCFuE21U',
    array('jquery'),
    '',
    false
  );
  ...
  wp_register_script(
    'davisdefense-scripts', 
    get_template_directory_uri() . '/js/davisdefense-scripts.js', 
    array('jquery'), 
    '', 
    true
  );
  ...
  wp_enqueue_script('davisdefense-scripts');  
}

add_action('wp_enqueue_scripts', 'davisdefense_styles');
function davisdefense_styles(){
...
add_action('acf/init', 'davisdefense_acf_init');
function davisdefense_acf_init(){
	acf_update_setting('google_api_key', 'AIzaSyDE4qr4rE24Aq6J45Zp6CZ2AIMqCFuE21U');
}
